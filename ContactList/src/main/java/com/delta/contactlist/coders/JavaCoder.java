 ...
 */
public class JavaCoder extends Contact.Person implements Coder {
    private static final String myLanguage = "Java";

    public JavaCoder(String id, String name, String occupation, String yearsCoding) {
